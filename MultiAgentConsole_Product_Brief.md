...
### Core Architecture
- **Multi-Agent System**: Specialized agents coordinated by a root agent
- **Flexible Model Support**: Compatible with various LLM providers through Google's ADK
- **Terminal UI**: Clean, responsive interface built with Textual
- **Dynamic Configuration**: On-the-fly model and agent settings changes
